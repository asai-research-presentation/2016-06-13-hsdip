...
+ Aras (Nakhost and Muller 2010)
  + Action Elimination(*AE*) --- remove unnecessary 
  + Plan Neighborhood Graph Search(*PNGS*)
+ Action Dependency (*AD*) (Chrpa, McCluskey and Osborne 2012) --- bra bra bra
...
#+BEGIN_XLARGE
#+BEGIN_CENTER
"Improvements" should outperform the simplest baseline ☹
#+END_CENTER
#+END_XLARGE
...
+ we can apply them at most once
#+END_ALIGNRIGHT
